...
class ItemCake extends StatefulWidget{
  ...
  const ItemCake({Key? key, required this.cakeModel, }) : super(key: key);

  @override
  _ItemCake createState()=> _ItemCake();
}
class _ItemCake extends State<ItemCake> {
          ...
          Row(
            children:[
              ...
              Container(
                ...
                child: Image.asset(widget.cakeModel.cakeImage,width: 150,height: 180,),
              ),
            ],
          ),
