...
import 'package:coffee/models/snak_model.dart';
...
class ItemSnack extends StatefulWidget{
  ...
  const ItemSnack({Key? key, required this.snackModel, }) : super(key: key);

  @override
  _ItemSnack createState()=> _ItemSnack();
}
class _ItemSnack extends State<ItemSnack> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(
                r'$ ''${widget.snackModel.snackPrice}',
                style:const TextStyle(
          ...
          Row(
            children:[
              ...
              Container(
                ...
                child: Image.asset(widget.snackModel.snackImage,width: 150,height: 180,),
              ),
            ],
          ),
